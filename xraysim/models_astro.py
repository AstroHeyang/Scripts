...
class MDBlackBody(Fittable1DModel):
    ...
    scale = Parameter(default=1e-30, min=0)
...
class SpecModel(object):
    ...
    def __init__(self, nh_gal, nh_host, rs, norm_par, main_mo):
        ...
        self.scale_factor = models.Scale(1.0 / (1.0 + rs))
        self.main = main_mo
        if not nh_host:
...
class PLSpec(SpecModel):
    """A class for absorbed power-law spectral model.
